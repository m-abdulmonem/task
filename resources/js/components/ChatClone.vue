    ...
    <div class="container app">
        <div class="row app-one">
                    ...
                    <div class="row searchBox">
                        <div class="col-sm-12 searchBox-inner">
                            <div class="form-group has-feedback">
                                <input id="searchText" class="form-control" name="searchText" placeholder="Search"
                                       type="text">
                ...
                <div class="side-two">
                    ...
                    <div class="row composeBox">
                        <div class="col-sm-12 composeBox-inner">
                            <div class="form-group has-feedback">
                                <input id="composeText" class="form-control" name="searchText" placeholder="Search People"
                                       type="text">
                                <span class="glyphicon glyphicon-search form-control-feedback"></span>
                            </div>
                        </div>
            ...
            <div class="col-sm-8 conversation">
                ...
                <div id="conversation" class="row message">
                ...
                <div class="row reply">
                    ...
                    <div class="col-sm-1 col-xs-1 reply-send">
                        <i aria-hidden="true" class="fa fa-send fa-2x"></i>
                    </div>
                </div>
            </div>
        </div>
